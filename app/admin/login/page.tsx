    ...
    <div className="py-12 bg-gradient-to-br from-pink-50 via-white to-blue-50 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 min-h-screen transition-colors">
      <div className="container mx-auto px-4">
        <div className="max-w-md mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8 border border-gray-200 dark:border-gray-700 transition-colors">
          <h1 className="text-4xl font-display font-bold mb-2 text-center bg-gradient-to-r from-pink-600 to-blue-600 dark:from-pink-400 dark:to-blue-400 bg-clip-text text-transparent">
            Admin Login
          </h1>
          <p className="text-center text-sm text-gray-500 dark:text-gray-400 mb-6">Sugarbunny Stores Administration</p>
          {error && (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <p className="text-center text-sm text-gray-600 dark:text-gray-400">
              <a href="/" className="text-pink-600 dark:text-pink-400 hover:text-pink-700 dark:hover:text-pink-300 font-medium">
                ← Back to Home
              </a>
            </p>
          </form>
